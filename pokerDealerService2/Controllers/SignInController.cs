...
namespace pokerDealerService2.Controllers
{
    public class SignInController : ApiController
    {
            ...
            string forename, string lastname, string email, string phone)
        {
            ...
            string queryString = "INSERT INTO dbo.Users (username, password," +
                " forename, lastname, email, phone) VALUES ('" + username + "', '" + password +
                   "', '" + forename + "', '" + lastname +
                   "', '" + email + "', '" + phone + "');";
            ...
            return "Sign in failed!" + rowsAffected.ToString();
        }
