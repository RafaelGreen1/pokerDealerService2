...
namespace pokerDealerService2.Controllers
{
    public class BetController : ApiController
    {
        ...
        // GET api/Bet
        public int GetBet(Int32 Id, Int32 dollars)
        {
            int[] Ids = new int[4];
            int location = 0;
            ...
            sql = "UPDATE dbo.Game SET currentFirstPlayer=" + location.ToString() + ";";
            ...
            sql = "UPDATE dbo.Game SET pot" + location.ToString() +
               "=pot" + location.ToString() + "+" + dollars.ToString() + ";";
            cmd = new SqlCommand(sql, conn);
            conn.Open();
